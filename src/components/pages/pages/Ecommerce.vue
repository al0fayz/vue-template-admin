            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active">
                  <img src="../../../assets/img/prod-1.jpg" alt="Product Image" />
                </div>
                <div class="product-image-thumb">
                  <img src="../../../assets/img/prod-2.jpg" alt="Product Image" />
                </div>
                <div class="product-image-thumb">
                  <img src="../../../assets/img/prod-3.jpg" alt="Product Image" />
                </div>
                <div class="product-image-thumb">
                  <img src="../../../assets/img/prod-4.jpg" alt="Product Image" />
                </div>
                <div class="product-image-thumb">
                  <img src="../../../assets/img/prod-5.jpg" alt="Product Image" />
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
